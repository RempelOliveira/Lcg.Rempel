(function ($, w, undefined) {
	...
	function Paginate() {
		...
		p.setPagingClasses = function (nav, currentPage, pageCount) {
			nav.find('li.footable-page > a[data-page=' + currentPage + ']').addClass("btn btn-primary").css({borderLeft: "none", borderRight: "none", borderTop: "1px solid #428bca", borderBottom: "1px solid #2d6ca3", borderRadius: "0", backgroundColor: "#2d6ca2", cursor: "pointer"}).parent().addClass('active');
		...
		p.fillPage = function (ft, tbody, pageNumber) {
			...
			$(".current-page").html("P&aacute;gina " + (pageNumber + 1) + " de " + ft.pageInfo.pages.length);
